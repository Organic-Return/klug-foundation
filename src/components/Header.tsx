                            ...
                            {column.title && (
                              column.titleUrl ? (
                                <Link
                                  ...
                                  onClick={() => setActiveDropdown(null)}
                                >
                                  <h3 className={`relative inline-block ${isSkiTown ? 'text-white' : 'text-gray-900'}`} style={{ fontSize: 'clamp(1.5rem, 3vw, 1.5rem)', fontWeight: 700, lineHeight: 1.3, letterSpacing: '-0.02em', fontFamily: 'var(--font-inter), system-ui, sans-serif' }}>
                                    {column.title}
                                ...
                                <h3 className={`mb-2 ${isSkiTown ? 'text-white' : 'text-gray-900'}`} style={{ fontSize: 'clamp(1.5rem, 3vw, 1.5rem)', fontWeight: 700, lineHeight: 1.3, letterSpacing: '-0.02em', fontFamily: 'var(--font-inter), system-ui, sans-serif' }}>
                                  {column.title}
                                </h3>
                              )
                            )}
