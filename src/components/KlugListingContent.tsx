...
export default function KlugListingContent({
  listing,
  agent,
  coAgent,
  googleMapsApiKey,
  ...
  return (
    <div className="min-h-screen bg-[var(--rc-cream)]">
      ...
      <div className={`max-w-[1400px] mx-auto px-6 md:px-8 pb-16 md:pb-24 ${!agent ? 'pt-7' : ''}`}>
        ...
        <div className={`grid grid-cols-1 ${agent ? 'lg:grid-cols-2' : 'lg:grid-cols-[2fr_1fr]'} gap-12 lg:gap-16 overflow-hidden`}>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div className="min-w-0 pt-2">
                    ...
                    <div className="mt-3 space-y-1.5">
                      {agent.phone && (
                        <a href={`tel:${phoneHref(agent.phone)}`} className="flex items-center gap-2 text-[var(--rc-brown)] text-sm hover:text-[var(--rc-gold)] transition-colors">
                          <svg className="w-3.5 h-3.5 text-[var(--rc-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {agent.mobile && agent.mobile !== agent.phone && (
                        <a href={`tel:${phoneHref(agent.mobile)}`} className="flex items-center gap-2 text-[var(--rc-brown)] text-sm hover:text-[var(--rc-gold)] transition-colors">
                          <svg className="w-3.5 h-3.5 text-[var(--rc-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                          </svg>
                          {formatPhone(agent.mobile)}
                        </a>
                      )}
                      {agent.email && (
                  ...
                  <div>
                    ...
                    <div className="flex items-start gap-5">
                      ...
                      <div className="min-w-0 pt-2">
                        ...
                        <div className="mt-3 space-y-1.5">
                          {coAgent.phone && (
                            <a href={`tel:${phoneHref(coAgent.phone)}`} className="flex items-center gap-2 text-[var(--rc-brown)] text-sm hover:text-[var(--rc-gold)] transition-colors">
                              <svg className="w-3.5 h-3.5 text-[var(--rc-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                              </svg>
                          ...
                          {coAgent.mobile && coAgent.mobile !== coAgent.phone && (
                            <a href={`tel:${phoneHref(coAgent.mobile)}`} className="flex items-center gap-2 text-[var(--rc-brown)] text-sm hover:text-[var(--rc-gold)] transition-colors">
                              <svg className="w-3.5 h-3.5 text-[var(--rc-gold)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                              </svg>
                              {formatPhone(coAgent.mobile)}
                            </a>
                          )}
                          {coAgent.email && (
