...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://klugproperties.com'),
  title: "Klug Properties",
  description: "Luxury Real Estate in Aspen and the Roaring Fork Valley",
};
